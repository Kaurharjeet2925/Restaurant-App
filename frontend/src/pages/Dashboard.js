  ...
  return (
    <div className="ml-64 mt-20 p-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <MenuItemCard title="Pending" value="122" gradient="bg-gradient-to-r from-yellow-500 to-amber-400" />
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            <tr className="border-b">
              ...
              <td>3 items</td>
              <td>$32</td>
              <td><span className="px-3 py-1 bg-green-100 text-green-600 rounded-full">Completed</span></td>
            </tr>
          </tbody>
        </table>
      </div>
